...
/* harmony import */ var _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_trades_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/trades/route.ts */ "(rsc)/./app/api/trades/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/deriv_trading_bot/nextjs_space/app/api/trades/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_trades_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/trades/route";
function patchFetch() {
...
async function GET(request) {
    try {
        ...
        const trades = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.trade.findMany({
            where: {
                userId
            },
            orderBy: {
...
async function POST(request) {
    try {
        ...
        const trade = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.trade.create({
            data: {
                userId,
                ...body,
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(trade);
    } catch (error) {
