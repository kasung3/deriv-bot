...
/* harmony import */ var _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_settings_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/settings/route.ts */ "(rsc)/./app/api/settings/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/deriv_trading_bot/nextjs_space/app/api/settings/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_settings_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET() {
    try {
        ...
        let settings = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.tradingSettings.findUnique({
            where: {
                userId
            }
        });
        if (!settings) {
            settings = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.tradingSettings.create({
                data: {
                    userId
                }
            });
...
async function PUT(request) {
    try {
        ...
        const settings = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.tradingSettings.upsert({
            where: {
                userId
            },
            update: body,
