...
/* harmony import */ var _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_stats_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/stats/route.ts */ "(rsc)/./app/api/stats/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/deriv_trading_bot/nextjs_space/app/api/stats/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_stats_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET() {
    try {
        ...
        const allTrades = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.trade.findMany({
            where: {
                userId,
                result: {
                    in: [
