...
/* harmony import */ var _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_tokens_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/tokens/route.ts */ "(rsc)/./app/api/tokens/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/deriv_trading_bot/nextjs_space/app/api/tokens/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_deriv_trading_bot_nextjs_space_app_api_tokens_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET() {
    try {
        ...
        const tokens = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.apiToken.findMany({
            where: {
                userId
            },
            select: {
...
async function POST(request) {
    try {
        ...
        if (!tokenType || !token) {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({
                error: "Token type and token are required"
            }, {
                status: 400
            });
        }
        ...
        const savedToken = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.apiToken.upsert({
            where: {
                userId_tokenType: {
                    userId,
                    tokenType
